...
## Hex file
If you prefer simplicity, and don't want to edit the code, a compiled HEX file is also available:  [Latest version](https://github.com/NMRduino/NMRduino/tree/main/Software/MCU/latest/NMRduino_v1.02-GPL3-release/NMRduino_v1.02-GPL3-release.ino.hex).
